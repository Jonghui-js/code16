...
class ipboardCl extends QuillClipboard {
...
class QuillEditor extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      editorHtml: __ISMSIE__ ? '<p>&nbsp;</p>' : `${this.props.content.text}`,
      files: [],
    };
  ...
  insertImage = (e) => {
    ...
    if (
      ...
      axios
        .post('/api/posts/uploadfiles', formData, config)
        .then((response) => {
